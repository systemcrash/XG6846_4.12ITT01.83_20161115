...
const uint32 cpu_speed_table[0x20] = {
    320, 320, 400, 400, 375, 375, 375, 375, 333, 333, 400, 400, 320, 320, 400, 400,
    0, 320, 160, 200, 160, 200, 400, 320, 320, 160, 384, 320, 192, 320, 320, 320
};
#endif


#if defined (CONFIG_BCM96816) || (defined (CONFIG_BCM96818) && defined(CONFIG_BRCM_6818_ON_6816))
const uint32 cpu_speed_table[0x20] = {
...
#if defined (CONFIG_BCM96818) && (!defined(CONFIG_BRCM_6818_ON_6816))
const uint32 cpu_speed_table[0x20] = {
