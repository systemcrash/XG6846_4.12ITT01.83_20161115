...
#include "xavi_config.h" /* XAVI Dom add for utils define */
...
#define DHCP_HTTP_IP            0x80
#define DHCP_8021Q_VLAN_ID      0x84
#define DHCP_OPT125				0x7d
#ifdef XAVI_UDHCPC_OPT224
#define DHCP_PRIVATE224			0xe0
#endif
#ifdef XAVI_UDHCPC_OPT250_APAS
#define DHCP_PRIVATE250			0xfa
#else
#endif
#endif
