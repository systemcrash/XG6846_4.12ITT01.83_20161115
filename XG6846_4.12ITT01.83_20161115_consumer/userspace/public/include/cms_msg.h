...
typedef enum 
{
   ...
   CMS_MSG_VOICE_CODEC_INFO                     = 0x10002106, /**< request for Voice Line obj */
#endif
...
#if !defined(XAVI_XG6846) && defined(XAVI_UDHCPC_OPTION)
   char staticRoute[BUFLEN_512];
   char vlanId[BUFLEN_32];
#endif
...
#ifdef XAVI_SIP_STACK
/** Data body for Voice Codec Info */
typedef struct
{
   char txCodec[BUFLEN_32];
   char rxCodec[BUFLEN_32];
} VoiceLineObjCodec;
#endif
