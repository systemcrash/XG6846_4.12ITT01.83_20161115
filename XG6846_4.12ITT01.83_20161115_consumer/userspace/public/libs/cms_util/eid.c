...
static CmsEntityInfo entityInfoArray[] = {
   ...
   {EID_XAVI_MONGOOSE,
    ...
    "mongoose",
    "/usr/bin/mongoose",
    "-p 80 -t 1 -d no -r /webs/fwd -m \"text/html\"",
    EIF_LAUNCH_ON_BOOT, /* EIF_ flags */
    0,                /* backlog for TCP server port */
    0,				/* TCP server port */
    TRUE,             /* isFeatureCompiledIn */
    0, 0, 0},
#endif /* End of XAVI_MONGOOSE */
...
{EID_OSGID,        /* eid */
   ...
   {EID_XAVI_WAN,
...
#ifdef XAVI_USER_SWITCH
    {EID_XAVI_SWITCH_DAEMON,
#if defined(XAVI_CLI_VLAN)
	/* Only necessary on CLI_VLAN function */
    NDA_ACCESS_CONSOLED,
#else
	0,
#endif
    "xavi_switch_daemon",
    "/bin/xavi_switch_daemon",
    "",                 /* run args */
    EIF_MDM | EIF_LAUNCH_ON_BOOT | EIF_MESSAGING_CAPABLE, /* EIF_ flags */
    0,                  /* backlog for TCP server port */
    0,                  /* TCP/UDP server port */
    ...
    0, 0, 0},           /* misc memory parameters */
#endif
#ifdef XAVI_MULTICAST
    {EID_XAVI_MULTICAST,
    0,
    "xavi_multicast",
    "/bin/multicastd",
    "",                 /* run args */
    EIF_LAUNCH_ON_BOOT | EIF_MESSAGING_CAPABLE, /* EIF_ flags */
    0,                  /* backlog for TCP server port */
    0,                  /* TCP/UDP server port */
    TRUE,               /* isFeatureCompiledIn */
    0, 0, 0},           /* misc memory parameters */
#endif
#ifdef XAVI_SW_UPGRADE
    {EID_XAVI_SW_UPGRADE,
    NDA_ACCESS_CONSOLED,
    "sw_upgrade",
    "/bin/sw_upgrade",
